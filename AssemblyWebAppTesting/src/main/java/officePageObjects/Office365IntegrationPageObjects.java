...
public class Office365IntegrationPageObjects {
	...
	By GetStartedButton = By.xpath("//span[@data-cy='ms-teams']/../../following-sibling::button");
	...
	public Office365IntegrationPageObjects(WebDriver driver) {
		this.driver = driver;
	}
